# Python constraints for 12.2 LTS (includes Apache Spark 3.3.2, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 12.2 LTS (includes Apache Spark 3.3.2, Scala 2.12).
...
- **Python Version**: 3.9
- **Total Constraints**: 123 packages

## Notes

- The constraints in these files represent the exact package versions available in 12.2 LTS (includes Apache Spark 3.3.2, Scala 2.12)
