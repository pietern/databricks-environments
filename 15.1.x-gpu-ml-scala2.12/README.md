# Python constraints for 15.1 ML (includes Apache Spark 3.5.0, GPU, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 15.1 ML (includes Apache Spark 3.5.0, GPU, Scala 2.12).
...
- **Python Version**: 3.11
- **Total Constraints**: 333 packages
- **Omitted Packages**: 3 packages (fasttext, flash-attn, tensorboard) - these packages could not be resolved and are excluded from constraints
