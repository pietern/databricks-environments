# Python constraints for 15.1  (includes Apache Spark 3.5.0, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 15.1  (includes Apache Spark 3.5.0, Scala 2.12).
...
- **Python Version**: 3.11
- **Total Constraints**: 131 packages

## Notes

- The constraints in these files represent the exact package versions available in 15.1  (includes Apache Spark 3.5.0, Scala 2.12)
