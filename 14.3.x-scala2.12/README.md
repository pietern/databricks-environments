# Python constraints for 14.3 LTS (includes Apache Spark 3.5.0, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 14.3 LTS (includes Apache Spark 3.5.0, Scala 2.12).
