# Python constraints for 16.1 ML (includes Apache Spark 3.5.2, GPU, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 16.1 ML (includes Apache Spark 3.5.2, GPU, Scala 2.12).
...
- **Python Version**: 3.12
- **Total Constraints**: 414 packages
- **Omitted Packages**: 1 packages (flash-attn) - these packages could not be resolved and are excluded from constraints
