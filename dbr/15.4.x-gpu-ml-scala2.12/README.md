# Python constraints for 15.4 LTS GPU ML

Constraint files to match your local Python environment to 15.4 LTS ML (includes Apache Spark 3.5.0, GPU, Scala 2.12).
...
- **Python Version**: 3.11
- **Total Constraints**: 368 packages
- **Databricks Connect**: 15.4 (available as dev dependency)
- **Incompatible Packages**: 3 packages (databricks-sdk, py4j, pyspark) - these packages conflict with databricks-connect and have been masked to allow local development
