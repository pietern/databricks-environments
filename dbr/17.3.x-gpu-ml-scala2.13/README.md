# Python constraints for 17.3 LTS GPU ML

Constraint files to match your local Python environment to 17.3 LTS ML (includes Apache Spark 4.0.0, GPU, Scala 2.13).
