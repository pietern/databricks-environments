# Python constraints for 14.2 CPU ML
...
- The constraints in these files represent the exact package versions available in 14.2 ML (includes Apache Spark 3.5.0, Scala 2.12)
