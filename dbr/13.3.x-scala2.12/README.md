# Python constraints for 13.3 LTS (includes Apache Spark 3.4.1, Scala 2.12)

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in 13.3 LTS (includes Apache Spark 3.4.1, Scala 2.12).
...
- **Python Version**: 3.10
- **Total Constraints**: 142 packages

## Notes

- The constraints in these files represent the exact package versions available in 13.3 LTS (includes Apache Spark 3.4.1, Scala 2.12)
