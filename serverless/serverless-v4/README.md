...
Constraint files to match your local Python environment to Databricks Serverless environment version 4.
...
- **Python Version**: 3.12
- **Total Constraints**: 219 packages
- **Databricks Connect**: 17.2 (available as dev dependency)
