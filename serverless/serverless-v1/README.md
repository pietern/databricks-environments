# Python constraints for Databricks Serverless environment version 1

These are Python environment constraint files that you can use to mirror the set of Python packages and the Python version used in Databricks Serverless environment version 1.
...
- **Python Version**: 3.10
- **Total Constraints**: 161 packages

## Notes

- The constraints in these files represent the exact package versions available in Databricks Serverless environment version 1
